...
public class SoftwareLicensAction extends SupervisorController {
	...
	public static void amountAdjust() {
	...
	public static void confirmAdjust() {
		...
		if (user.ipsAcctNo == null || "".equals(user.ipsAcctNo)) {
			error.msg = "该用户未开通第三方账户，代理充值失败！";
			renderJSON(error);
		}
		PaymentProxy.getInstance().agentRechargeAdj(error, Constants.PC,    
