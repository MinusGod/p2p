...
public class AppConstants {
	...
	public static final int APP_INVEST_BILLS = 35;  //投资子账户--投资账单
	...
	public static final int APP_INVEST_RECORDS = 40;  //投资子账户--投标记录
	public static final int APP_LOANING_INVEST_BIDS = 41;  //投资子账户--等待满标的投资标
	public static final int APP_RECEVING_INVEST_BIDS = 42;  //投资子账户---收款中的投资标列表
	public static final int APP_TRANSFER_DEBT = 43;  //转让债权
	public static final int APP_SUCCESS_DEBT = 44;  // 投资子账户--已成功的投资标
	...
	public static final int APP_INVEST_STATISTICS = 61;  //投资情况统计表
	...
	public static final int APP_UNAME_PHONE_VERIFY = 176; //
	public static final int APP_FIND_PWD_BY_SMS_T = 177; //
	
	public static final int APP_QUEST_INFO = 180; //标的回复
	
	
	public static final int APP_CAPITAL_PROTECTION_PHOTO = 181; //查询本金保障页面
	public static final int APP_CREATE_ACCOUNT = 201; //开通汇付账号
	public static final int APP_RECHARGE_BANKLIST = 202; //银行列表
	public static final int APP_RECHARGE = 203; //用户充值确认
	public static final int APP_QUERY_CREATE_INFO = 204; //查询用户开户信息
	public static final Integer APP_RECHARGE_N = 170;
}
