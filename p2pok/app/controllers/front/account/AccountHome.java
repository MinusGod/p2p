...
public class AccountHome extends BaseController {
	...
	public static void loanAccount(){
		...
		render(user, accountStatistics, news, fundraiseingBid, toSubmitItemBid, recentlyRepayBills,backstageSet, content,warmPrompt);
	}
	...
	public static void exportLoanBills() {
    	...
    	File file = ExcelUtils.export(
    			"我的借款账单", 
    			arrBills,
				new String[] {"账单标题", "本期需还本息","借款管理费","本期需还总额", "是否逾期", "还款状态", "到期还款时间", "实际还款时间"}, 
				new String[] {"title", "repayment_amount", "manager_amount","sum_amount","is_overdue", "status", "repayment_time", "real_repayment_time"});
