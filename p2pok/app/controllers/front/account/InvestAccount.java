...
public class InvestAccount extends BaseController {
	...
	public static void investAccount(){
		...
		render(user, accountStatistics, qualityBids, qualityDebts, fundraiseingBid, news, backstageSet, content,warmPrompt);
	}
