...
public class AgentPayment {
	 ...
	 * @param error
	 */
	public static void insertUserAgentPay(User user, String agentOrderNo, String merOrderNo, double amount, int status, int agent, ErrorInfo error) {
		error.clear();
	 ...
	 */
	public static void updateAgentRechargeStatus(long agentOrderNo, int fromStatus, int toStatus, ErrorInfo error) {
		error.clear();
	 ...
	 * @return 
	 */
	public static t_user_agent_pay queryAgentPayByAgentNo(long agentOrderNo) {
