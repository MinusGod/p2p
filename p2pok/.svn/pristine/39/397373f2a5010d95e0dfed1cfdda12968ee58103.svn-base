...
public class Page  implements Serializable{
	...
	private String getMixedThemeScript(){
		...
		//总页数 == 1
		if(totalPageCount == 1){
			strBuff.append("<i >共计"+totalCount+""+pageTitle+"（共"+totalPageCount+"页）</i>");
			return strBuff.toString();
		}
		...
		strBuff.append("<i>共计"+totalCount+""+pageTitle+"（共"+totalPageCount+"页）</i>");
		if(currPage != 1){
			strBuff.append("<a  onclick=\"javascript:"+defaultMethod+"("+up+","+pageSize+");\">上一页</a>");
		}
		...
		if(showPageCount != 2){
			...
			for(i = inter[0]; i <=totalPageCount; i++ ){
				...
				if(sum == showPageCount){
					...
					strBuff.append("&nbsp;<a  onclick=\"javascript:"+defaultMethod+"("+totalPageCount+","+pageSize+")\">"+totalPageCount+"</a>");
					break;
				}
				sum ++;
				if(currPage == i){
					strBuff.append("&nbsp;<a class=\"click\" onclick=\"javascript:"+defaultMethod+"("+i+","+pageSize+")\">"+i+"</a>");
				}else{
					strBuff.append("&nbsp;<a onclick=\"javascript:"+defaultMethod+"("+i+","+pageSize+")\">"+i+"</a>");
				}
			}
		}else{
			up = 1;down = 2;
			if(currPage == 1){
				strBuff.append("&nbsp;<a class=\"click\" onclick=\"javascript:"+defaultMethod+"("+up+","+pageSize+")\">"+up+"</a>");
				strBuff.append("&nbsp;<a  onclick=\"javascript:"+defaultMethod+"("+down+","+pageSize+")\">"+down+"</a>");
			}else{
				strBuff.append("&nbsp;<a  onclick=\"javascript:"+defaultMethod+"("+up+","+pageSize+")\">"+up+"</a>");
				strBuff.append("&nbsp;<a class=\"click\" onclick=\"javascript:"+defaultMethod+"("+down+","+pageSize+")\">"+down+"</a>");
			}
		}
		
		if(currPage != totalPageCount){
			strBuff.append("&nbsp;<a onclick=\"javascript:"+defaultMethod+"("+down+","+pageSize+")\">下一页</a>");
		}
		
		strBuff.append("<input type=\"text\" id=\"goPage\" value=\""+currPage+"\">");
		strBuff.append("<a id=\"jumpPage\" onclick=\"javascript:jumpPage("+pageSize+")\">跳转</a>");
	...
	private String getForeGroundTheme(){
		...
		String myUrl = Request.current().actionMethod;
		if(totalPageCount == 1) {
			strBuff.append("<i >共"+totalPageCount+"页&nbsp;</i>");
			return strBuff.toString();
		}
		...
		// ---------样式 2012-07-10 增加 begin-------------
			strBuff.append("<a href=\""+upPage+"\">上一页</a>");
		...
		if(showPageCount != 2){
			...
			for(i = inter[0]; i <=totalPageCount; i++ ){
				if(sum == showPageCount){
					...
					strBuff.append("&nbsp;<a href=\""+myUrl+"?currPage="+totalPageCount+"&pageSize="+pageSize+"&"+conditions+ "\">"+totalPageCount+"</a>");
					break;
				}
				sum ++;
				if(currPage == i){
					strBuff.append("&nbsp;<a class=\"click\" href=\""+myUrl+"?currPage="+i+"&pageSize="+pageSize+"&"+conditions+"\">"+i+"</a>");
				}else{
					strBuff.append("&nbsp;<a href=\""+myUrl+"?currPage="+i+"&pageSize="+pageSize+"&"+conditions+"\">"+i+"</a>");
				}
			}
		}else{
			int tempCurrPage = currPage;
			if(currPage == 1){
				...
				strBuff.append("&nbsp;<a class=\"click\" href=\""+myUrl+"?currPage="+lastPage+"&pageSize="+pageSize+"&"+conditions+"\">"+tempCurrPage+"</a>");
				strBuff.append("&nbsp;<a href=\""+myUrl+"?currPage="+nextPage+"&pageSize="+pageSize+"&"+conditions+"\">"+(tempCurrPage+1)+"</a>");
			}else{
				if(currPage == totalPageCount){
					tempCurrPage = totalPageCount - 1;
				}
				strBuff.append("&nbsp;<a href=\""+myUrl+"?currPage="+lastPage+"&pageSize="+pageSize+"&"+conditions+"\">"+tempCurrPage+"</span></a>");
				strBuff.append("&nbsp;<a class=\"click\" href=\""+myUrl+"?currPage="+nextPage+"&pageSize="+pageSize+"&"+conditions+"\">"+(tempCurrPage+1)+"</a>");
			}
		}
			strBuff.append("&nbsp;<a href=\""+dwonPage+"\">下一页</a>");
		return strBuff.toString();
	}
