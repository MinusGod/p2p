...
public class DealType {
	...
	public static final int CHARGE_INVEST_FEE = 313; // 扣除投资管理费  (t_invests id)
...
//	public static final int CPS_AMOUNT = 52; // cps推广奖励（按投资金额）(t_invests id)
	...
	public static final int ADVANCE_FEE = 4; //垫付投资账单(t_bills id)
	public static final int LOAN_FEE = 5; //借款管理费(t_bids id)
	public static final int INVEST_FEE = 6; //投资管理费(t_invests id)
